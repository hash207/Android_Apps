...
title = Smart Home with Python

# (str) Package name
package.name = smarthomeapp
...
requirements = kivy==2.3.0,kivymd==1.1.1,pillow==10.2.0,requests
...
# bin_dir = mnt/c/Users/osama/Desktop/Hashem/My Work/GUI/Android
